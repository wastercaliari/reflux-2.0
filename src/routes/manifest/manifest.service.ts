    ...
    return {
      movies: [
        ...
        },
        {
          type: 'national',
          label: 'Nacionais',
          url: 'https://xn--90afacv0cu2a3cr.xn--p1ai/browse-filmes-nacional-videos-%page%-date.html',
          items: [],
        },
        {
          type: '2024',
          label: 'Melhores de 2024',
          url: 'https://xn--90afacv0cu2a3cr.xn--p1ai/browse-filmes-de-2024-videos-%page%-date.html',
          items: [],
        },
        {
          type: '2023',
          label: 'Melhores de 2023',
          url: 'https://xn--90afacv0cu2a3cr.xn--p1ai/browse-filmes-de-2023-videos-%page%-date.html',
          items: [],
        },
        {
          type: '2022',
          label: 'Melhores de 2022',
          url: 'https://xn--90afacv0cu2a3cr.xn--p1ai/browse-filmes-de-2022-videos-%page%-date.html',
          items: [],
        },
        {
          type: '2021',
          label: 'Melhores de 2021',
          url: 'https://xn--90afacv0cu2a3cr.xn--p1ai/browse-filmes-de-2021-videos-%page%-date.html',
          items: [],
        },
      ],
      series: [
